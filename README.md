...
### 기록하는 HR &rarr; 예측하는 HR

중소기업을 위한 **데이터 기반 All-in-One 스마트 HRMS**<br>
인사 데이터를 중앙화하고 AI로 선제적 인사이트를 제공하는 HR 담당자의 **'Second Brain'**
...
<!-- TODO: GitHub Actions 파이프라인, AWS 배포 구성도 -->
